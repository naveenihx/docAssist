...
GENDER, PHOTO, LOCATION, AGE, BIO,OTHER,DURATION = range(7)
...
async def other(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    """Starts the conversation and asks the user about their gender."""
    reply_keyboard = [["Cough","Weakness"]]

    await update.message.reply_text(
        "Do you have any other symptoms",
        reply_markup=ReplyKeyboardMarkup(
            reply_keyboard, one_time_keyboard=True, input_field_placeholder="symptoms?"
        ),
    )
